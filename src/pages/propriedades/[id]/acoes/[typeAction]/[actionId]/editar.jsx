...
function AcoesPropriedadeEditar() {
  ...
  const { id, actionId, typeAction } = router.query;
  ...
  const handleSubmit = async dt => {
    ...
    const schema = PropertiesActionsService.schema(typeAction);
    ...
    if (schema) {
      schema
        ...
        .then(async d => {
          ...
          await PropertiesActionsService.update(actionId, d, typeAction).then(
            res => {
          ...
          <SectionHeader>
            <SectionHeaderContent
              ...
              description={`Aqui, você irá editar a ação ${actionsList[
                typeAction
              ]?.label.toLowerCase()} em questão da propriedade ${data?.name}.`}
                  ...
                  <>
                    <Form
                      ...
                      initialData={{
                        ...
                        time_finish: removeTimeSeconds(dataActions?.time_finish)
                      }}
                    >
                      <ActionsForm
...
export default privateRoute()(AcoesPropriedadeEditar);
