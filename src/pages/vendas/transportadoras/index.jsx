...
function VendasTransportadoras() {
  ...
  return (
    <>
      <Head>
        <title>Suas Transportadoras - Agro7</title>
      </Head>
      ...
      <Container>
        ...
        <Section>
          <SectionHeader>
            <SectionHeaderContent title="Suas Transportadoras" />
          </SectionHeader>
          <SectionBody>
                          ...
                          {(!isEmpty(data?.items) &&
                            data.items.map(p => (
                              <tr
                                ...
                                onClick={() =>
                                  router.push(
                                    `/vendas/transportadoras/${p?.id}/detalhes`
                                  )
                                }
                              >
                                <td>{p?.name}</td>
                                ...
                                <td onClick={e => e.stopPropagation()}>
                                  <ActionButton
                                    id={p.id}
                                    path={`/vendas/transportadoras/${p?.id}`}
                                    noEdit
...
export default privateRoute()(VendasTransportadoras);
